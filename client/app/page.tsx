  ...
  return (
    <div className="relative flex flex-col min-h-screen bg-[#050510] overflow-hidden">
      ...
      <div className="pointer-events-none fixed inset-0 z-0">
        ...
        <div className="absolute bottom-[-10%] right-[-5%] h-[500px] w-[500px] rounded-full bg-[#34d399]/15 blur-[120px] animate-float-delayed" />
      </div>
        ...
        <div className="mb-10 text-center animate-fade-in-up">
          ...
          <h1 className="mb-3">
            <span className="block text-4xl sm:text-5xl font-bold tracking-tight leading-[1.1]">
              <span className="text-white">Will &amp; </span>
              <span className="bg-gradient-to-r from-[#7c6cf0] via-[#34d399] to-[#7c6cf0] bg-[length:200%_auto] animate-gradient-shift bg-clip-text text-transparent">
                Testament
              </span>
            </span>
          </h1>
          ...
          <p className="mx-auto max-w-lg text-sm sm:text-base leading-relaxed text-white/40">
            Create immutable wills on the blockchain. Designate beneficiaries and release your inheritance when the time comes — no middlemen, no lawyers.
          </p>
